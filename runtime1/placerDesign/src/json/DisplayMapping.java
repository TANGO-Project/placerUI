...
public class DisplayMapping {
	...
	public void creationPNGMapping(Mapping mapping) {
        ...
        File source = new File(new File(new File("").getAbsolutePath()).getParentFile().getParent()+"\\Downloads\\Mapping-"+mapping.getHardwareName()+".png");
	    //File source = new File("C:\\Users\\Utilisateur\\Downloads\\"+mapping.getHardwareName()+".png"); 
	    System.out.println(source.exists());
	    File destinationPNG = new File(((MainPlacerOut)mapping.eContainer()).getFilePath()+"\\Mapping-"+mapping.getHardwareName()+".png"); 
	    ...
	    File displayDiagramSequenceFile = new File(((MainPlacerOut)mapping.eContainer()).getFilePath()+"\\Mapping-"+mapping.getHardwareName()+".txt");
