...
/**
 * This is the item provider adapter for a {@link placer.Task} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TaskItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						PlacerPackage.Literals.TASK__NAME, true, false, false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(PlacerPackage.Literals.TASK__TRANSMISSIONS);
			childrenFeatures.add(PlacerPackage.Literals.TASK__IMPLEMENTATIONS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(PlacerPackage.Literals.TASK__TRANSMISSIONS,
				PlacerFactory.eINSTANCE.createTransmission()));

		newChildDescriptors.add(createChildParameter(PlacerPackage.Literals.TASK__IMPLEMENTATIONS,
				PlacerFactory.eINSTANCE.createImplementation()));
	}
